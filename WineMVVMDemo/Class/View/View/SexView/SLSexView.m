...
- (void)initView
{
    ...
    leftLabel.text          = @"先生";
    leftLabel.font          = [UIFont sl_NormalFont:15];
    leftLabel.textColor     = SLCOLOR(70, 70, 70, 1);
    ...
    rightLabel.text         = @"女士";
    rightLabel.font         = [UIFont sl_NormalFont:15];
    rightLabel.textColor    = SLCOLOR(70, 70, 70, 1);
