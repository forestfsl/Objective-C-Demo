...
@implementation SLStarView


- (instancetype)initWithFrame:(CGRect)frame starSize:(CGSize)starSize withStyle:(SLStarType)style
{
...
- (void)initView
{
    ...
    if (self.starType == SLStarTypeInteger)
    {
        for (int i = 0; i < 5; i++)
        {
