...
#import "SLOrderStateTableViewCell.h"


@interface SLOrderStateTableView ()<UITableViewDelegate,UITableViewDataSource>


@end

@implementation SLOrderStateTableView
...
- (void)config
{
    ...
    self.delegate           = self;
    [self registerNib:[UINib nibWithNibName:@"SLOrderStateTableViewCell" bundle:[NSBundle mainBundle]] forCellReuseIdentifier:@"cell"];
...
{
    SLOrderStateTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"cell"];
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if ([headView viewWithTag:100])
    {
        ...
        typeLable.textColor = SLCOLOR(100, 100, 100, 1);
        typeLable.font      = [UIFont sl_NormalFont:14];
        ...
        noLabel.textColor   = SLCOLOR(100, 100, 100, 1);
        noLabel.font        = [UIFont sl_NormalFont:14];
