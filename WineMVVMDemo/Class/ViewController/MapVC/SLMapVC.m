...
@interface SLMapVC ()<UITableViewDelegate,UITableViewDataSource,BMKPoiSearchDelegate,BMKMapViewDelegate,BMKGeoCodeSearchDelegate,UISearchBarDelegate>
...
///搜索框tableView
@property(nonatomic,strong)SLMapSearchTableView    *searchTableView;
...
- (SLMapSearchTableView *)searchTableView
{
    if (!_searchTableView)
    {
        _searchTableView = [[SLMapSearchTableView alloc]initWithFrame:CGRectMake(0, 64, kWidth, kHeight - 64) style:UITableViewStylePlain];
