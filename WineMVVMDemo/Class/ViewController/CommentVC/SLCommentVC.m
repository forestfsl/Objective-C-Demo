...
@interface SLCommentVC ()

@property(nonatomic,strong)SLCommentViewModel  *viewModel;
...
- (void)bindViewModel {
    ...
    self.starView.starBlock = ^(NSString *star){
        ...
        [self.starLabel setText:self.starLabel.text Font:[UIFont sl_NormalFont:16] withColor:THEME_COLOR Range:NSMakeRange(3, star.length)];
    };
...
-(void)configSubView {
    ...
    self.view.backgroundColor = SLCOLOR(250, 250, 250, 1);
    ...
    SLOrderDetailModel *model = self.viewModel.order.ordergoods.firstObject;
    ...
    self.starLabel.textColor    = SLCOLOR(150, 150, 150, 1);
    self.starLabel.font         = [UIFont sl_NormalFont:16];
    self.starLabel.text         = @"评分：5.0";
    [self.starLabel setText:self.starLabel.text Font:[UIFont sl_NormalFont:16] withColor:THEME_COLOR Range:NSMakeRange(3, 3)];
    ...
    line.backgroundColor = SLCOLOR(222, 222, 222, 1);
    ...
    self.textView.font = [UIFont sl_NormalFont:17];
    ...
    self.addBtn.titleLabel.font = [UIFont sl_NormalFont:16];
    ...
    tipLabel.text = @"匿名评价";
    tipLabel.textColor = SLCOLOR(188, 188, 188, 1);
    tipLabel.font = [UIFont sl_NormalFont:14];
    ...
    self.commitBtn.titleLabel.font = [UIFont sl_NormalFont:20];
...
- (void)backBtnClick
{
    ...
    [action2 setValue:SLCOLOR(30, 30, 30, 1) forKey:@"titleTextColor"];
...
- (SLStarView *)starView
{
    if (!_starView)
    {
        _starView = [[SLStarView alloc]initWithFrame:CGRectMake(80, 40, 220, 40) starSize:CGSizeZero withStyle:SLStarTypeInteger];
    }
    return _starView;
}
- (UILabel *)starLabel
