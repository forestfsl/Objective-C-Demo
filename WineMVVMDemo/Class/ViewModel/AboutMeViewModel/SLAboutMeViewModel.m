...
@interface SLAboutMeViewModel ()<UIImagePickerControllerDelegate,UINavigationControllerDelegate>

///昵称
@property(nonatomic,strong)UITextField *textField;
@end

@implementation SLAboutMeViewModel
        ...
        if (indexPath.section == 0)
        {
            switch (indexPath.row)
            {
                case 0:
                {
                    ...
                    [action1 setValue:SLCOLOR(30, 30, 30, 1) forKey:@"titleTextColor"];
                    [action2 setValue:SLCOLOR(30, 30, 30, 1) forKey:@"titleTextColor"];
                    [action3 setValue:SLCOLOR(80, 80, 80, 1) forKey:@"titleTextColor"];
                ...
                case 1:
                {
                    ...
                    [action1 setValue:SLCOLOR(122, 230, 90, 1) forKey:@"titleTextColor"];
                    [action2 setValue:SLCOLOR(150, 150, 150, 1) forKey:@"titleTextColor"];
                ...
                case 2:
                {
                    ...
                    [action1 setValue:SLCOLOR(80, 80, 80, 1) forKey:@"titleTextColor"];
                    [action2 setValue:SLCOLOR(80, 80, 80, 1) forKey:@"titleTextColor"];
